      ...
      <v-container grid-list-xl>
        <v-layout wrap>
          ...
          <v-flex v-for="img in images" :key="img" xs3>
            <v-img :class="[image === img ? 'image-active' : '']" :src="img" height="120"
            @click.native="setImage(img)"/>
          </v-flex>
          <v-flex xs12>
            <v-btn href="https://www.creative-tim.com/product/vuetify-material-dashboard" target="_blank"
              color="success" block>
              Free Download
            </v-btn>
          </v-flex>
          <v-flex xs12>
            <v-btn href="https://demos.creative-tim.com/vuetify-material-dashboard/documentation"
              target="_blank" class="white--text" color="primary" block>
              Documentation
            </v-btn>
          </v-flex>
          <v-flex xs12>
